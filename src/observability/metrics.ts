...
collectDefaultMetrics({ prefix: "dispatch_process_", register: metricsRegistry });

export const eventsAdmitted = new Counter({
  name: "dispatch_events_admitted_total",
...
export const executionsCreated = new Counter({
  name: "dispatch_executions_created_total",
...
export const executionOutcomes = new Counter({
  name: "dispatch_execution_outcomes_total",
...
export const sandboxProvisionDuration = new Histogram({
  name: "dispatch_sandbox_provision_duration_seconds",
...
export const sandboxClaims = new Counter({
  name: "dispatch_sandbox_claims_total",
...
export const outboxAttempts = new Counter({
  name: "dispatch_outbox_publish_attempts_total",
...
export const scheduleOccurrences = new Counter({
  name: "dispatch_schedule_occurrences_total",
...
export const scheduleAdmissionDelay = new Histogram({
  name: "dispatch_schedule_admission_delay_seconds",
...
export const checkpointAdvances = new Counter({
  name: "dispatch_checkpoint_advances_total",
...
export const revisionResolutions = new Counter({
  name: "dispatch_revision_resolutions_total",
...
export const githubEffects = new Counter({
  name: "dispatch_github_effects_total",
...
export const workerLoopFailures = new Counter({
  name: "dispatch_worker_loop_failures_total",
...
const executions = new Gauge({ name: "dispatch_executions", help: "Current executions by durable state.", labelNames: ["tenant", "state"] as const, collect: collectDatabase, registers: [metricsRegistry] });
const oldestActiveExecution = new Gauge({ name: "dispatch_execution_oldest_active_age_seconds", help: "Age of the oldest active execution.", labelNames: ["tenant"] as const, collect: collectDatabase, registers: [metricsRegistry] });
const overdueExecutions = new Gauge({ name: "dispatch_executions_overdue", help: "Active executions past their persisted timeout.", labelNames: ["tenant"] as const, collect: collectDatabase, registers: [metricsRegistry] });
const pendingOutbox = new Gauge({ name: "dispatch_outbox_pending", help: "Pending outbox messages by topic.", labelNames: ["tenant", "topic"] as const, collect: collectDatabase, registers: [metricsRegistry] });
const oldestPendingOutbox = new Gauge({ name: "dispatch_outbox_oldest_pending_age_seconds", help: "Age of the oldest pending outbox message by topic.", labelNames: ["tenant", "topic"] as const, collect: collectDatabase, registers: [metricsRegistry] });
const scheduleLateness = new Gauge({ name: "dispatch_schedule_next_fire_delay_seconds", help: "Seconds an enabled schedule is past its next expected fire time.", labelNames: ["tenant", "trigger_id"] as const, collect: collectDatabase, registers: [metricsRegistry] });
const scheduleMissedIntervals = new Gauge({ name: "dispatch_schedule_missed_intervals", help: "Expected schedule intervals elapsed since next_fire_at.", labelNames: ["tenant", "trigger_id"] as const, collect: collectDatabase, registers: [metricsRegistry] });
const checkpointAge = new Gauge({ name: "dispatch_checkpoint_age_seconds", help: "Age of the oldest checkpoint for a binding.", labelNames: ["tenant", "binding_id"] as const, collect: collectDatabase, registers: [metricsRegistry] });
const activeWorkloads = new Gauge({ name: "dispatch_sandbox_claims_active", help: "Durably owned active SandboxClaim workloads.", labelNames: ["tenant"] as const, collect: collectDatabase, registers: [metricsRegistry] });
const pendingRevisions = new Gauge({ name: "dispatch_revision_resolutions_pending", help: "Pending or retrying revision resolutions.", labelNames: ["tenant"] as const, collect: collectDatabase, registers: [metricsRegistry] });
const collectorUp = new Gauge({ name: "dispatch_observability_collector_up", help: "Whether the last PostgreSQL observability collection succeeded.", collect: collectDatabase, registers: [metricsRegistry] });
const snapshotAge = new Gauge({ name: "dispatch_observability_snapshot_age_seconds", help: "Age of the last successful PostgreSQL observability snapshot.", collect: collectDatabase, registers: [metricsRegistry] });
