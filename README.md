...
| `AGENTBAY_RECONCILER_GRACE_MINUTES` | `30` | Minutes of grace time added to `spec.lifecycle.shutdownTime` before the reconciler CronJob deletes an expired `SandboxClaim`. |
